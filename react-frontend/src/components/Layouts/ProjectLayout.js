...
<li
                onClick={() => {
                  setCurrentActiveTab2("organisation");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "organisation",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "organisation" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "organisation",
                      "text-black": props?.currentActiveTab2 !== "organisation",
                    })}
                  >
                  Organisation
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "organisation",
                      "text-yellow-700": props?.currentActiveTab2 !== "organisation",
                    })}
                  >

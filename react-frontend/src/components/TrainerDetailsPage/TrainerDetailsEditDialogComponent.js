...
const TrainerDetailsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            trainerNRIC: _entity?.trainerNRIC,
...
nationality: _entity?.nationality,
    ...
    return (
        <Dialog header="Edit TrainerDetails" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>

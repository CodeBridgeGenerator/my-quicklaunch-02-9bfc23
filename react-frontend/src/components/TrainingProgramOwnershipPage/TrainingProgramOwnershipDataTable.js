...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.organisationType}</p>
...
<Column field="organisationType" header="OrganisationType" body={pTemplate1} filter={selectedFilterFields.includes("organisationType")} hidden={selectedHideFields?.includes("organisationType")}  sortable style={{ minWidth: "8rem" }} />
